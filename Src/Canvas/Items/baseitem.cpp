...
BaseItem::BaseItem(const QPoint &startPoint, const QPoint &endPoint)
{
    m_pos = (startPoint + endPoint) / 2;
}

bool BaseItem::selectedOpPoint(const QPoint &pos)
{
...
void BaseItem::move(const QPoint &pos)
{
...
Qt::CursorShape BaseItem::hoverStyle(const QPoint &pos)
{
    Q_UNUSED(pos)
...
void BaseItem::paint(QPainter *painter, bool isShowOP)
{
    painter->save();
