...
ShapeArrowsUpItem::ShapeArrowsUpItem(const QPoint &startPoint, const QPoint &endPoint)
    :RectOpItem(startPoint, endPoint)
{
    drawing(startPoint, endPoint);
}

void ShapeArrowsUpItem::updatePath()
{
    m_path.clear();
    ...
    m_path.lineTo(QPointF(left + width / 4.0, bottom));
    m_path.lineTo(QPointF(right - width / 4.0, bottom));
