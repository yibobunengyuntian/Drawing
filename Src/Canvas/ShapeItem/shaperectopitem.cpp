...
ShapeRectOpItem::ShapeRectOpItem(const QPoint &startPoint, const QPoint &endPoint)
...
void ShapeRectOpItem::drawing(const QPoint &startPoint, const QPoint &endPoint)
{
...
Qt::CursorShape ShapeRectOpItem::hoverStyle(const QPoint &pos)
{
    int index = -1;
...
void ShapeRectOpItem::updatePath()
{
    m_opPath.clear();
    m_opPath.addRect(QRect(m_opPoints.first(), m_opPoints.last()));
}

void ShapeRectOpItem::moveOneOp(const QPoint &pos)
{
